<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="post_list.aspx.cs" Inherits="DTcms.Web.plugins.forum.admin.post_list" %>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#new DTcms.Web.plugins.forum.BLL.forum_posts().GetUserName(Convert.ToInt32(Eval("user_id")))%></td>
      <td><%#new DTcms.Web.plugins.forum.BLL.forum_board().GetBoardName(Convert.ToInt32(Eval("board_id")))%></td>
