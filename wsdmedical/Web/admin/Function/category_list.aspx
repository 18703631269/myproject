<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category_list.aspx.cs" Inherits="Web.admin.Function.category_list" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" id="a_add" runat="server" href="category_edit.aspx?action=Add"><i></i><span>新增</span></a></li>
                            <li>
                ...
                <HeaderTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                        <tr>
                            ...
                            <th align="left">显示状态</th>
                            <th align="left">权限控制</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="category_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&qx=category_list.aspx&id=<%#Eval("id")%>"><%#Eval("title")%></a>
                        </td>
                        <td><%#Convert.ToInt32(Eval("is_lock")) == 0 ? "×" : "√"%></td>
                        ...
                        <td align="center">
                            <a href="category_edit.aspx?action=<%#DTEnums.ActionEnum.Add %>&qx=category_list.aspx&id=<%#Eval("id")%>">添加子类</a>
                            <a href="category_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&qx=category_list.aspx&id=<%#Eval("id")%>">>修改</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
