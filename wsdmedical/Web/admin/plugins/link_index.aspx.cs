...
{
    public partial class link_index : ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "Page_Load", ex.Message);
            }
        }
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            rptList.DataSource = new linkBll().GetList(pageSize, this.page, _strWhere, _orderby, out this.totalCount);
            DataBind();
            txtPageNum.Text = pageSize.ToString();
            string str = Utils.CombUrlTxt("link_index.aspx", "keywords={0}&page={1}&property={2}", new string[] { keywords, "__id__", property });
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect(Utils.CombUrlTxt("link_index.aspx", "keywords={0}&property={1}", new string[] { keywords, property }));
            }
            catch (Exception ex)
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "txtPageNum_TextChanged", ex.Message);
            }
        }
        ...
        protected void lbtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AddAdminLog("删除", string.Concat(new object[] { "删除幻灯片成功", num, "条，失败", num2, "条" }));
                JscriptMsg(string.Concat(new object[] { "删除成功", num, "条，失败", num2, "条！" }), Utils.CombUrlTxt("link_index.aspx", "keywords={0}", new string[] { keywords }));
            }
            catch (Exception ex)
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "lbtnDelete_Click", ex.Message);
            }
        }
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                AddAdminLog("审核", "审核幻灯片");
                JscriptMsg("批量审核成功！", Utils.CombUrlTxt("link_index.aspx", "keywords={0}&property={1}", new string[] { keywords, property }));
            }
            catch (Exception ex)
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "lbtnUnLock_Click", ex.Message);
            }
        }
        ...
        protected void lbtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                AddAdminLog("编辑", "修改幻灯片插件排序:");
                JscriptMsg("保存排序成功！", Utils.CombUrlTxt("link_index.aspx", "keywords={0}&property={1}", new string[] { keywords, property }));
            }
            catch (Exception ex)
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "lbtnSave_Click", ex.Message);
            }
        }
        ...
        protected void lbtnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect(Utils.CombUrlTxt("link_index.aspx", "keywords={0}&property={1}", new string[] { txtKeywords.Text, property }));
            }
            catch (Exception ex)
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "lbtnSearch_Click", ex.Message);
            }
        }
        ...
        protected void ddlProperty_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //channel_id = 14;
                Response.Redirect(Utils.CombUrlTxt("link_index.aspx", "keywords={0}&property={1}", txtKeywords.Text, ddlProperty.SelectedValue), false);
            }
            catch (Exception ex)
            {
                Common.CommomFunction.WriteLog("link_index.aspx", "ddlProperty_SelectedIndexChanged", ex.Message);
            }
        }
    }
}