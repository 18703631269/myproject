<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slidelink_index.aspx.cs" Inherits="Web.admin.plugins.slidelink_index" %>
        ...
        <div id="floatHead" class="toolbar-wrap">
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div class="l-list">
                        <ul class="icon-list">
                            <li><a class="add" runat="server" id="a_add" href="slidelink_edit.aspx?action=Add"><i></i><span>新增</span></a></li>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href="slidelink_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&qx=link_index.aspx&id=<%#Eval("id")%>"><%#Eval("title") %></a></td>
                        <td>
                        ...
                        <td align="center"><a href="slidelink_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&qx=link_index.aspx&id=<%#Eval("id")%>">修改</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
