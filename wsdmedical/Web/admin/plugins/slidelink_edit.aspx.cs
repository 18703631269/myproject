...
{
    public partial class slidelink_edit : ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Common.CommomFunction.WriteLog("slidelink_edit.aspx", "Page_Load", ex.Message);
            }
        }
        ...
        private void ShowInfo(int _id)
        {
            try
            {
                slidelink model = new slidelinkBll().GetModel(_id);
            ...
            {
                throw new Exception("--slidelink_edit.aspx-->ShowInfo" + ex.Message, ex);
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
                {
                    ...
                    {
                        JscriptMsg("修改链接成功！", "slidelink_index.aspx");
                    }
                }
                else
                {
                    ...
                    {
                        JscriptMsg("添加链接成功！", "slidelink_index.aspx");
                    }
            ...
            {
                Common.CommomFunction.WriteLog("slidelink_edit.aspx", "btnSubmit_Click", ex.Message);
            }
        }
        ...
        private bool DoAdd()
        {
            try
            {
                ...
                {
                    AddAdminLog("新增", "添加友情链接：" + model.title);
                    flag = true;
                }
                return flag;
            }
            ...
            {
                throw new Exception("--slidelink_edit.aspx-->DoAdd" + ex.Message, ex);
            }
        }
        ...
        private bool DoEdit(int _id)
        {
            try
            {
                ...
                bool flag = false;
                slidelinkBll lkBll = new slidelinkBll();
                slidelink model = lkBll.GetModel(_id);
                model.title = this.txtTitle.Text.Trim();
                model.is_lock = Utils.StrToInt(this.rblIsLock.SelectedValue, 0);
                model.sort_id = Utils.StrToInt(this.txtSortId.Text.Trim(), 0x63);
                model.link_url = this.txtSiteUrl.Text.Trim();
                ...
                {
                    AddAdminLog("编辑", "修改友情链接：" + model.title);
                    flag = true;
                }
                return flag;
            }
            ...
            {
                throw new Exception("--slidelink_edit.aspx-->DoEdit" + ex.Message, ex);
            }
        }
