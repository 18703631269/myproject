<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_list.aspx.cs" Inherits="Web.admin.manager.pmenu_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" id="a_add" runat="server" href="role_edit.aspx?action=Add"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><a href="role_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&qx=pmenu_list.aspx&id=<%#Eval("id")%>"><%#Eval("role_name")%></a></td>
      <td><%#GetTypeName( Convert.ToInt32(Eval("role_type")))%></td>
      <td align="center"><a href="role_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&qx=pmenu_list.aspx&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
