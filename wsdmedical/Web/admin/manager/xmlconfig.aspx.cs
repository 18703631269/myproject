...
{
    public partial class xmlconfig : ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Common.CommomFunction.WriteLog("xmlconfig.aspx", "Page_Load", ex.Message);
            }
        }
        ...
        {
            sys_configBll bll = new sys_configBll();
            sys_config model = bll.loadConfig();

            webname.Text = model.webname;
            weburl.Text = model.weburl;
            webcompany.Text = model.webcompany;

            staticstatus.Text = model.staticstatus.ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                AddAdminLog("编辑", "修改系统配置信息"); //记录日志
                JscriptMsg("修改系统配置成功！", "xmlconfig.aspx");
            }
            catch(Exception ex)
            {
                Common.CommomFunction.WriteLog("xmlconfig.aspx", "btnSubmit_Click", ex.Message);
            }
        }
    }
}