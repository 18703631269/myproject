    ...
    <form id="form1" runat="server">
        ...
        <div class="tab-content">
            ...
            <dl id="div_attach_container" runat="server" visible="false">
              ...
              <dl id="dlFylx"  runat="server" visible="false">
                <dt>翻译类型</dt>
                <dd>
                    <div class="rule-multi-checkbox">
                    <asp:CheckBoxList ID="cbFylx" RepeatDirection="Horizontal" RepeatLayout="Flow" runat="server"></asp:CheckBoxList>
                        </div>
                    <span class="Validform_checktip">*翻译陪同的类别</span>
                </dd>
            </dl>
              <dl id="dlCity"  runat="server" visible="false">
                <dt>所在城市</dt>
                <dd>
                    <div class="rule-multi-checkbox" style="width:620px;">
                        <asp:CheckBoxList ID="cbCity" RepeatDirection="Horizontal" RepeatLayout="Flow" runat="server"></asp:CheckBoxList>
                        </div> 
                    <span class="Validform_checktip">*翻译陪同的所在城市</span>
                </dd>
            </dl>
              <dl id="dlHospl"  runat="server" visible="false">
                <dt>所在医院</dt>
                <dd>
                    <asp:TextBox ID="txthospl" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
                    <span class="Validform_checktip">*翻译陪同的所在医院最多100个字符</span>
                </dd>
            </dl>
              <dl  id="dlZyxlzt"  runat="server" visible="false">
                <dt>专业学历状态</dt>
                <dd>
                    <asp:TextBox ID="txtzyxlzt" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
                    <span class="Validform_checktip">*人员信息专业学历状态最多100个字符</span>
                </dd>
            </dl>
              <dl id="dlPaymoney"  runat="server" visible="false">
                <dt>收费方式</dt>
                <dd>
                    <asp:TextBox ID="txtpaymoney" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />
                    <span class="Validform_checktip">*收费方式最多100个字符</span>
                </dd>
            </dl>
            <dl id="ddYybzj"  runat="server" visible="false">
                <dt>预约保证金</dt>
                <dd>
                    <asp:TextBox ID="txtYYbzj" runat="server" CssClass="input normal" ignore="ignore" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" " />
                    <span class="Validform_checktip">*预约保证金，数字或保留2位小数</span>
                </dd>
            </dl>
              <dl id="dlZslx"  runat="server" visible="false">
                <dt>住宿类型</dt>
                <dd  >
                    <div>
                      <asp:DropDownList ID="ddlZslx" runat="server" ></asp:DropDownList>
                     </div> 
                    <span class="Validform_checktip">*住宿类型</span>
                </dd>
            </dl>
              <dl id="dlMdcity"  runat="server" visible="false">
                <dt >目的城市</dt>
                <dd>
                     <div>
                      <asp:DropDownList ID="ddlmdcity" runat="server"></asp:DropDownList>
                    </div>
                    <span class="Validform_checktip">*住宿城市等</span>
                </dd>
            </dl>
             <dl  id="dlSzjc"  runat="server" visible="false">
                <dt>所在机场</dt>
                <dd>
                    <div>
                      <asp:DropDownList ID="ddlSzjc" runat="server" ></asp:DropDownList>
                     </div> 
     <%--               <asp:TextBox ID="txtszjc" runat="server" CssClass="input normal" datatype="*0-100" sucmsg=" " />--%>
                    <span class="Validform_checktip">*接机人应去所在机场最多100个字符</span>
                </dd>
            </dl>
            <dl>
                <dt>文章内容</dt>
