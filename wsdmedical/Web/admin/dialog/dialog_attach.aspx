<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attach.aspx.cs" Inherits="Web.admin.dialog.dialog_attach" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //初始化上传控年
            $(".upload-attach").InitUploader({ filesize: "102400", sendurl: "../../tools/file_upload.ashx", swf: "../../scripts/webuploader/uploader.swf", filetypes: "txt" });
        //远程或者本地上传
        ...
        <div class="div-content">
            ...
            <div class="dl-attach-box" style="display: none;">
                <dl>
                    <dt>附件名称</dt>
                    <dd>
                        <input type="text" id="txtRemoteTitle" class="input txt" /></dd>
                </dl>
                <dl>
                    <dt>远程地址</dt>
                    <dd>
                        <input type="text" id="txtRemoteUrl" class="input txt" />
                        <span>*以“http://”开头</span></dd>
                </dl>
            </div>
        </div>
    </form>
