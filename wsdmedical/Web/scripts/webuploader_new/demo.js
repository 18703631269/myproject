...
jQuery(function () {
    var $ = jQuery,    // just in case. Make sure it's not an other libaray.
        ...
        $statusBar = $wrap.find('.statusBar').find('.btns'),
        // 文件总体选择信息。
       //$info = $statusBar.find('.info'),
       $info = $wrap.find('.statusBar').find('.info'),
        // 上传按钮
        ...
        $progress = $wrap.find('.statusBar').find('.progress').hide(),
        // 添加的文件数量
        fileCount = 0,
    ...
    uploader = WebUploader.create({
        ...
        chunked: true,
        server: '../../tools/file_upload.ashx?action=uploadimages',
        fileNumLimit: 999,
