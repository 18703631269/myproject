        ...
        private Model.article DataRowToModel(DataRow row)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    if (row["details_one"] != null && row["details_one"].ToString() != "")
                    {
                        model.details_one = row["details_one"].ToString();
                    }
                    if (row["details_two"] != null && row["details_two"].ToString() != "")
                    {
                        model.details_two = row["details_two"].ToString();
                    }
                    if (row["details_three"] != null && row["details_three"].ToString() != "")
                    {
                        model.details_three = row["details_three"].ToString();
                    }

                    if (row["details_four"] != null && row["details_four"].ToString() != "")
                    {
                        model.details_four = row["details_four"].ToString();
                    }


                    if (row["detail_title_one"] != null && row["detail_title_one"].ToString() != "")
                    {
                        model.detail_title_one = row["detail_title_one"].ToString();
                      
                    }
                    if (row["detail_title_two"] != null && row["detail_title_two"].ToString() != "")
                    {
                        model.detail_title_two = row["detail_title_two"].ToString();
                    }
                    if (row["detail_title_three"] != null && row["detail_title_three"].ToString() != "")
                    {
                        model.detail_title_three = row["detail_title_three"].ToString();
                    }
                    if (row["detail_title_four"] != null && row["detail_title_four"].ToString() != "")
                    {
                        model.detail_title_four = row["detail_title_four"].ToString();
                    }


                    if (row["fylx"] != null && row["fylx"].ToString() != "")
                    {
                    ...
                    if (row["hospl"] != null && row["hospl"].ToString() != "")
                    {
                        model.hospl = row["hospl"].ToString();
                    }
                    if (row["zyxlzt"] != null && row["zyxlzt"].ToString() != "")
                    {
                        model.zyxlzt = row["zyxlzt"].ToString();
                    }
                    if (row["paymoney"] != null && row["paymoney"].ToString() != "")
                    {
                        model.paymoney = row["paymoney"].ToString();
                    }
                    if (row["zslx"] != null && row["zslx"].ToString() != "")
                    {
                        model.zslx = row["zslx"].ToString();
                    }
                    if (row["mdcity"] != null && row["mdcity"].ToString() != "")
                    {
                        model.mdcity = row["mdcity"].ToString();
                    }
                    if (row["szjc"] != null && row["szjc"].ToString() != "")
                    {
                        model.szjc = row["szjc"].ToString();
                    }
                    if (row["chjj"] != null && row["chjj"].ToString() != "")
                    {
                        model.chjj = Convert.ToDouble(row["chjj"]);
                    }
            ...
            {
                throw new Exception("--articleDal-->DataRowToModel" + ex.Message, ex);
            }
        }
        #endregion
