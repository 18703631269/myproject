    ...
    public class linkDal
    {
        ...
        public int Add(link model)
        {
            ...
            try
            {
                ...
                builder.AppendFormat("insert into dt_link(");
                ...
                DataTable _dt = _access.getDataTable("SELECT max(id) from dt_link;");
                if (results > 0)
                {
                    if (_dt.Rows.Count > 0)
                    {
        ...
        public bool Delete(int id)
        {
            ...
            {
            StringBuilder builder = new StringBuilder();
            builder.Append("delete from dt_link ");
        ...
        public bool Exists(int id)
        {
            ...
            { 
            StringBuilder builder = new StringBuilder();
            builder.Append("select id from dt_link");
            builder.AppendFormat(" where id={0} ", id);
        ...
        public DataTable GetTop5List()
        {
            ...
            {
                StringBuilder builder = new StringBuilder();
                builder.Append("select top 5 id,title,link_url,img_url,sort_id,is_lock,add_time ");
                builder.Append(" FROM dt_link where is_lock=1 order by sort_id asc ");
        ...
        public DataTable GetList(string strWhere)
        {
            ...
            {
                throw new Exception("--linkDal-->GetList" + ex.Message, ex);
            }
        }
        ...
        public DataSet GetList(int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            ...
            { 
            StringBuilder builder = new StringBuilder();
            builder.Append("select * FROM dt_link");
            if (strWhere.Trim() != "")
            {
                builder.Append(" where " + strWhere);
            }
        ...
        public link GetModel(int id)
        {
            ...
            { 
            StringBuilder builder = new StringBuilder();
            builder.Append("select top 1 id,title,link_url,img_url,sort_id,is_lock,add_time,add_user from dt_link ");
            builder.AppendFormat(" where id={0}", id);
            link link = new link();
        ...
        public bool Update(link model)
        {
            ...
            { 
            StringBuilder builder = new StringBuilder();
            builder.AppendFormat("update dt_link set ");
        ...
        public void UpdateField(int id, string strValue)
        {
            ...
            { 
            StringBuilder builder = new StringBuilder();
            builder.AppendFormat("update dt_link set " + strValue);
